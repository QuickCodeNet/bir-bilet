...
using QuickCode.BirBilet.Domain.Shared.Abstractions.Helpers;

namespace QuickCode.BirBilet.Domain.Shared.Abstractions.Nswag.Extensions
{
    public static class NswagExtensions
    {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            ...
            string namespacePrefix = "QuickCode.BirBilet.Domain.Shared.Abstractions.Nswag.Clients.")
        {
        ...
        public static void AddServiceClient(this IServiceCollection services, IConfiguration configuration,
            Type type, bool addRetryHandler = false,
            string namespacePrefix = "QuickCode.BirBilet.")
        {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            Assembly assembly, bool addRetryHandler=false, string namespacePrefix = "QuickCode.BirBilet.Domain.Shared.Abstractions.Nswag.Clients.")
        {
