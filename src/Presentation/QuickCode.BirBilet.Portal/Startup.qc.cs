...
using QuickCode.BirBilet.Infrastructure.Integration.Helpers;
...
using QuickCode.BirBilet.Portal.Mapper;
using QuickCode.BirBilet.Portal.ViewEngines;
using QuickCode.BirBilet.Infrastructure.Web.Middleware;
using QuickCode.BirBilet.Portal.Middleware;
