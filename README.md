# 🚀 BirBilet - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/bir-bilet.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.BirBilet.Docker.sln
  ```
...
**BirBilet** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
bir-bilet/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.BirBilet.Gateway/
      QuickCode.BirBilet.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/bir-bilet)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://bir-bilet-gateway.quickcode.net](https://bir-bilet-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://bir-bilet-portal.quickcode.net](https://bir-bilet-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://bir-bilet-gateway.quickcode.net](https://bir-bilet-gateway.quickcode.net)
- **Portal:**
    - link: [https://bir-bilet-portal.quickcode.net](https://bir-bilet-portal.quickcode.net)
- **Module APIs:**
    - link: [https://bir-bilet-identity-module.quickcode.net](https://bir-bilet-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["bir-bilet-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://bir-bilet-identity-module.quickcode.net"
        }
      }
    }
  }
...
1. Open `src/QuickCode.BirBilet.Docker.sln` in Rider.
...
**Last generation Time**: [Generated on: 2026-07-22 20:45:40 UTC]